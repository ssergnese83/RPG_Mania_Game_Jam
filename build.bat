...
g++ src/main.cpp src/0_startup_screen/startup_screen.cpp src/1_title_screen/title_screen.cpp src/2_menu_screen/menu_screen.cpp -o game -I include -I classes -lraylib -lopengl32 -lgdi32 -lwinmm